...
class gameGui:
    ...
    def getInput(self, key):
        ...
        if key[pygame.K_UP]:
            ...
            if rendered_text:
                self.__screen.blit(rendered_text, self.__textBox.topleft)
            if(self.__posY>0 and valid):
                if(isinstance(oldLoc, House)):
                    self.__screen.blit(imageHouse, (self.__posX, self.__posY))
                else:
                    self.__screen.blit(imageTile, (self.__posX, self.__posY))
                
                self.__posY = self.__posY-155
        ...
        if key[pygame.K_DOWN]:
            ...
            if(self.__posY < (155*3) and valid):
                if(isinstance(oldLoc, House)):
                    self.__screen.blit(imageHouse, (self.__posX, self.__posY))
                else:
                    self.__screen.blit(imageTile, (self.__posX, self.__posY))
        ...
        if key[pygame.K_LEFT]:
            ...
            if(self.__posX>0 and valid):
                if(isinstance(oldLoc, House)):
                    self.__screen.blit(imageHouse, (self.__posX, self.__posY))
                else:
                    self.__screen.blit(imageTile, (self.__posX, self.__posY))
                
                self.__posX = self.__posX-155
        ...
        if key[pygame.K_RIGHT]:
            ...
            if(self.__posX <= (155*3) and valid):
                if(isinstance(oldLoc, House)):
                    self.__screen.blit(imageHouse, (self.__posX, self.__posY))
                else:
                    self.__screen.blit(imageTile, (self.__posX, self.__posY))
